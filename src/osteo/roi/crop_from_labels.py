...
def crop_from_labels(img_path: str, label_path: str, output_dir: str) -> None:
    '''
    Read a YOLO-format label file, denormalize boxes, and save crops.
    Side assignment: left if normalised x-centre < 0.5, right otherwise.
    ...
    for idx, line in enumerate(lines):
        ...
        cv2.imwrite(str(out / f'{stem}_{side}_{idx}.png'), crop)
